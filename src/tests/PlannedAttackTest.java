...
public class PlannedAttackTest {
    ...
    public void setUp() throws Exception {
        ...
        attack = new PlannedAttack(delay){ @Override public void attack(Character attacker, Character victim) { } };
    }
    
    @Test(expected = IllegalArgumentException.class)
    public void testPlannedAttackLong_NegativeDelay_IllegalArgumentException() {
        new PlannedAttack(-1){ @Override public void attack(Character attacker, Character victim) { } };
    }

    @Test
    public void testPlannedAttackLong_ZeroDelay_NoExceptions() {
        new PlannedAttack(0){ @Override public void attack(Character attacker, Character victim) { } };
    }
